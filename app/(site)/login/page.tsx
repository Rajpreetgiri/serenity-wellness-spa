        ...
        <div className="bg-white/70 backdrop-blur-xl border border-mint-200/40 rounded-3xl sm:rounded-4xl
          ...
          <div className="text-center mb-7 sm:mb-10">
            <Link href="/" className="inline-flex items-center gap-2 group mb-6 sm:mb-8">
              ...
              <span className="font-heading text-lg sm:text-xl text-spa-text" style={{ fontFamily: "var(--font-cormorant)" }}>
                Serenity
              </span>
            </Link>
            ...
            <p className="font-body text-xs sm:text-sm text-spa-muted">Continue your wellness journey</p>
          </div>

          {sessionExpired && (
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-3.5 mb-6 flex gap-2.5">
              <AlertCircle className="w-4 h-4 text-amber-500 flex-shrink-0 mt-0.5" />
              <p className="font-body text-xs text-amber-700">Your session expired. Please sign in again.</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5 sm:mb-2">
                ...
                <Link href="/forgot-password" className="font-body text-[10px] sm:text-xs text-spa-accent hover:text-spa-text transition-colors">
                  Forgot password?
                </Link>
              </div>
