  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-spa-bg via-mint-50 to-peach-100/20
      ...
      <motion.div
        ...
        className="fixed top-20 right-0 sm:right-10 w-40 h-40 sm:w-60 sm:h-60 lg:w-72 lg:h-72
                   rounded-[60%_40%_30%_70%/60%_30%_70%_40%] bg-mint-200/15 blur-3xl pointer-events-none"
      />
      ...
      >
        <div className="bg-white/70 backdrop-blur-xl border border-mint-200/40 rounded-3xl sm:rounded-4xl
            ...
            <AnimatePresence mode="wait">
              {!sent ? (
                <motion.div key="pre" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-mint-100 rounded-xl sm:rounded-2xl
                                  flex items-center justify-center mx-auto mb-4 sm:mb-5">
                    <Mail className="w-7 h-7 sm:w-8 sm:h-8 text-spa-accent" strokeWidth={1.5} />
                  </div>
                  <h1
                ...
                >
                  <motion.div
                    ...
                    className="w-14 h-14 sm:w-16 sm:h-16 bg-spa-accent rounded-xl sm:rounded-2xl
                               flex items-center justify-center mx-auto mb-4 sm:mb-5 shadow-green"
                  >
                    <CheckCircle className="w-7 h-7 sm:w-8 sm:h-8 text-white" strokeWidth={1.5} />
                  </motion.div>
                  <h1
                    className="font-heading text-spa-text mb-2"
                    style={{ fontFamily: "var(--font-cormorant)", fontSize: "clamp(1.6rem, 5vw, 2.2rem)" }}
                  ...
                  <p className="font-body text-xs sm:text-sm text-spa-muted text-center">
                    We&apos;ve sent a reset link to{" "}
                    <span className="font-medium text-spa-accent break-all">{submittedEmail}</span>
                  </p>
                  <p className="font-body text-[10px] sm:text-xs text-spa-muted/60 mt-2 text-center">
          ...
          <Link
            href="/login"
            className="inline-flex items-center gap-2 font-body text-xs sm:text-sm text-spa-muted
                       hover:text-spa-accent transition-colors mt-5 sm:mt-6 mx-auto w-full justify-center"
          >
